...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple，可选heo,landing
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '早出晚归的蜗牛', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://doctor.cq.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '医生，博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'snail@yixuefu.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 一个小插件展示你的facebook fan page~ @see https://xx.andys.pro/article/add-facebook-fanpage-notionnext
  FACEBOOK_PAGE_TITLE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_TITLE || null, // 邊欄 Facebook Page widget 的標題欄，填''則無標題欄 e.g FACEBOOK 粉絲團'
  FACEBOOK_PAGE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE || null, // Facebook Page 的連結 e.g https://www.facebook.com/xx.andys.pro
